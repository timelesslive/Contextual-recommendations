...
class FullyConnectedLayer(nn.Module):
    def __init__(self, input_size, hidden_size, bias, batch_norm=True, dropout_rate=0.5, activation='relu', sigmoid=False, dice_dim=2):
        # input_size: 216 , hidden_size :[200,80,1] , bias:[True, True,False] ,batch_norm:False , sigmoid:true 
        ...
        # cur layers : {Linear(in_features=216, out_features=200, bias=True)}
    ...
    def forward(self, x):
        # once in : (batch_size, seq_len , dim_input) : (2,8,320)  
        # final in : (2,216)
